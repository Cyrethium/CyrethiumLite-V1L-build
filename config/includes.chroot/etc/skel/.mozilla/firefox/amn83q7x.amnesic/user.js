/**
 * Cyrethium Amnesic Firefox - user.js
 * 
 ...
 * Crated for extra hardened amnesic browsing experience.   
 */
...
user_pref("browser.newtabpage.enabled", false);                  // Disable activity-stream new tab
user_pref("browser.newtab.preload", false);                      // Do not preload new tab
...
// ===== Amnesic Minimal UI (No Private Mode, No DevTools, No Bookmarks) =====
// Keep the browser extremely simple; retain extensions functionality only
user_pref("browser.privatebrowsing.autostart", false);                 // Do not auto-start private browsing
user_pref("browser.places.history.enabled", false);                    // Do not keep browsing history
user_pref("browser.toolbars.bookmarks.visibility", "never");         // Hide bookmarks toolbar
user_pref("browser.bookmarks.editDialog.showForNewBookmarks", false);  // Hide edit dialog for new bookmarks
user_pref("browser.bookmarks.max_backups", 0);                         // Do not create bookmark backups
// Disable Developer Tools entry points
user_pref("devtools.enabled", false);
user_pref("devtools.debugger.remote-enabled", false);
user_pref("devtools.webide.enabled", false);
user_pref("devtools.f12_enabled", false);                              // Disable F12 shortcut (if supported)
user_pref("devtools.contextmenu.enabled", false);                      // Hide "Inspect" in context menu

// Minimal toolbar layout (no bookmarks/developer/library/home buttons)
user_pref("browser.uiCustomization.state", "{\"placements\":{\"nav-bar\":[\"back-button\",\"forward-button\",\"stop-reload-button\",\"urlbar-container\",\"downloads-button\",\"PanelUI-button\"],\"toolbar-menubar\":[\"menubar-items\"],\"TabsToolbar\":[\"tabbrowser-tabs\",\"new-tab-button\",\"alltabs-button\"],\"PersonalToolbar\":[\"personal-bookmarks\"]},\"seen\":[\"developer-button\",\"bookmarks-menu-button\",\"library-button\",\"home-button\"],\"dirtyAreaCache\":[\"nav-bar\",\"TabsToolbar\",\"toolbar-menubar\",\"PersonalToolbar\"],\"currentVersion\":20,\"newElementCount\":0}");

// Keep extensions functional and up-to-date
user_pref("extensions.update.enabled", true);
user_pref("extensions.update.autoUpdateDefault", true);
...
user_pref("privacy.clearOnShutdown.sessions", true);          // Clear active logins and sessions
...
user_pref("privacy.resistFingerprinting.letterboxing", true);   // Enable letterboxing to reduce fingerprinting
...
user_pref("privacy.clearOnShutdown.sessions", true);         // Clear active logins and sessions
user_pref("privacy.clearOnShutdown.siteSettings", true);     // Clear site settings
user_pref("privacy.sanitize.sanitizeOnShutdown", true);      // Enable sanitize on shutdown
...
user_pref("browser.sessionstore.resume_from_crash", false);  // Do not restore session after crash
user_pref("browser.sessionstore.max_windows_undo", 0);       // Disable window restore
...
user_pref("network.proxy.autoconfig_url", "file:///etc/cyrethium/onion.pac");
...
user_pref("browser.messaging-system.enabled", false);
