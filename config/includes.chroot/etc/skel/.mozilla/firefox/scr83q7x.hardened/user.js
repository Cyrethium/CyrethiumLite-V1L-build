/**
 * Cyrethium Hardened Firefox - user.js
 * 
...
user_pref("browser.newtabpage.activity-stream.pinned", "[{\"url\":\"https://duckduckgo.com/\",\"label\":\"DuckDuckGo\"}]"); 
...
// Disable private browsing autostart (remove incognito mode)
...
user_pref("privacy.clearOnShutdown.cookies", false);         // Keep cookies
user_pref("privacy.clearOnShutdown.downloads", false);       // Keep downloads list
user_pref("privacy.clearOnShutdown.formdata", false);        // Keep form data
user_pref("privacy.clearOnShutdown.history", false);         // Keep history
user_pref("privacy.clearOnShutdown.offlineApps", false);     // Keep offline website data
user_pref("privacy.clearOnShutdown.sessions", false);        // Keep sessions for usability
